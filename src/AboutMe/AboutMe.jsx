      ...
      <div className="info">
        <div className="summary-text">
          ...
          <p>
            ...
            Through my coursework and job experience I have developed a strong
            foundation in programming languages, algorithms, data structures,
        ...
        <div className="skills">
          <h1>Specialties</h1>
          <p>
            Software Development, Game Development, Web Development, Mobile
            Development, Object Oriented Programming, Data Structures,
            Algorithms, Agile Methodologies, Version Control, UI/UX Design
          </p>
          <p>
            React.js, JavaScript, HTML, CSS, Java, C# in Unity, gdscript, Swift,
            TypeScript, C, MySQL, Node.js, Express.js
          </p>
          <p>
            Visual Studio Code, Xcode, GitHub, Adobe Photoshop, Godot, Windows,
            Linux, GBStudio, p5play, Firebase, IntelliJ IDEA
          </p>
        </div>
        <div className="work">
          ...
          <div className="toast">
            ...
            <p>
              ...
              restaurant employees. Employed Agile methodologies to effectively
          ...
          <div className="kotini">
            ...
            <p>
              Utilized Typescript, React.js, and CSS to build website components
              for a tech-startup. Developed strong communication and
              collaboration skills through group projects and interactions with
              peers in my field of study.
            </p>
          </div>
          <div className="camp">
            ...
            <p>
              ...
              interpersonal communication skills with success in coordinating
              activities and sustaining camp missions and programs.
            </p>
          </div>
        </div>
        <div className="education">
          ...
          <div className="london">
            <h1>Foundation for Internation Education (FIE)</h1>
            <p>
